        ...
        <>
            ...
            <TabPanel value={0} index={0}>
                <Alert icon={<InfoOutlinedIcon fontSize="inherit"/>} severity="info">
                    Nesse módulo você encontra grupos e formulários padrões de anamnese, basta importar os modelos no
                ...
                <Box sx={{marginTop: "1rem", width: "100%", display: "flex", justifyContent: "space-between"}}>
                    <Button variant="contained" startIcon={<AddIcon/>} onClick={handleToggleDialog}>Adicionar Grupo de
                        Anamnese</Button>
