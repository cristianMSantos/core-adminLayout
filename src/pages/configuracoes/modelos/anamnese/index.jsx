...
import { TabPanel, a11yProps, AnamneseDialog} from "../../../../components";
        ...
        <>
            ...
            <TabPanel value={0} index={0}>
                ...
                <Box sx={{marginTop:"1rem", width:"100%", display:"flex", justifyContent:"space-between"}}>
                    <Button  variant="contained" startIcon={<AddIcon />} onClick={handleToggleDialog}>Adicionar Grupo de Anamnese</Button>
